                            ...
                            <div className={cx('content-wp')}>
                                ...
                                <div className={cx('yeu-cua-va-tieu-chi')}>
                                    <div className={cx('yeu-cua-va-tieu-chi-left')}>
                                        ...
                                        <p>
                                            ...
                                            <span>
                                                {data.linhVucNgheNghiep
                                                    ? data.linhVucNgheNghiep && data.linhVucNgheNghiep.length > 0
                                                        ? data.linhVucNgheNghiep.map((item) => {
                                                              const id = uuidv4();
                                    ...
                                    <div className={cx('yeu-cua-va-tieu-chi-right')}>
                                        ...
                                        <p>
                                            ...
                                            <span>
                                                {data.diaDiemMongMuonLamViec
                                                    ? data.diaDiemMongMuonLamViec &&
                                                      data.diaDiemMongMuonLamViec.length > 0
                                                        ? data.diaDiemMongMuonLamViec.map((item) => {
                                                              const id = uuidv4();
                                ...
                                <div className={cx('goi-thieu-va-muc-tieu-nghe-nghiep')}>
                                    <div className={cx('gioi-thieu')}>
                                        ...
                                        <p>
                                            Với kinh nghiệm nhiều năm làm việc từ làm các starup đến các công ty, tập
                                            đoàn lớn trong và ngoài nước. Với kinh nghiệm kinh doanh và quản lý có thể
                                            đáp ứng các yêu cầu mà quý công ty mong muốn.
                                        </p>
                                    </div>
                                    <div className={cx('muc-tieu-nghe-nghiep')}>
                                        ...
                                        <p>
                                            Luôn muốn là chuyên gia trong lĩnh vực mình làm việc mà bản thân mình làm
                                            việc. Mong tạo ra giá trị cho bản thân ở công việc, muốn phát triển công ty
                                            cùng công ty họp tác lâu dài. Sẽ làm tốt nhất, hoành thành công việc nhanh
                                            nhất và hiệu quả nhất. Tìm công việc lương cao, chế độ tốt Công việc ổn định
                                            và lâu dài Môi trường & văn hóa công ty tốt Có thể học hỏi thêm kinh nghiệm,
                                            nâng cao trình độ
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className={cx('hoc-van')}>
                                    <div className="mb-3">
                                        <ul>
                                            ...
                                            <li>
                                                <span className={cx('fw-500', 'me-1')}>Đơn vị đào tạo:</span> Đại học
                                    ...
                                    <div className="mb-3">
                                        <ul>
                                            ...
                                            <li>
                                                <span className={cx('fw-500-title', 'me-1')}>Đơn vị đào tạo:</span> Đại
                                ...
                                <div className={cx('hoc-van')}>
                                    <div className="mb-3">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                triển khai kế hoạch kinh doanh theo định hướng của BGĐ Tìm kiếm đối tác,
                                                cơ hội hợp tác B2B chào bán các sản phẩm dịch vụ của công ty. Đề xuất
                                                cho BGĐ các mô hình, định hướng kinh doanh hiệu quả cho các mảng sản
                                                phẩm dịch vụ của công ty Đào tạo hướng dẫn, xây dựng và phát triển lực
                                                lượng nhân sự bán hàng Kiểm soát tiến độ thực hiện KPI của phòng, của cá
                                                nhân
                                            </li>
                                        </ul>
                                    </div>
                                    <div className="mb-3">
                                        <ul>
                                            ...
                                            <li>
                                                <span className={cx('fw-600', 'me-1')}>Công ty:</span> Đại học Công Nghệ
                                                TP HCM - HUTECH
                                            </li>
                                            <li>
                                                <span className={cx('fw-500', 'me-1')}>Mô tả:</span> Xây dựng, triển
                                                khai kế hoạch kinh doanh theo định hướng của BGĐ Tìm kiếm đối tác, cơ
                                                hội hợp tác B2B chào bán các sản phẩm dịch vụ của công ty. Đề xuất cho
                                                BGĐ các mô hình, định hướng kinh doanh hiệu quả cho các mảng sản phẩm
                                                dịch vụ của công ty Đào tạo hướng dẫn, xây dựng và phát triển lực lượng
                                                nhân sự bán hàng Kiểm soát tiến độ thực hiện KPI của phòng, của cá nhân
                                            </li>
                                        </ul>
                                    </div>
                                </div>

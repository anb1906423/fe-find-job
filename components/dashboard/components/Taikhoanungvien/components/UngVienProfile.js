            ...
            <div className="row" onKeyDown={(e) => handleOnKeyDown(e)}>
                ...
                <div className='col-12 mt-3' style={{ textAlign: 'justify' }}>
                    ...
                    <Radio.Group onChange={handleChange} name="trinhDoTiengAnh">
                        <Radio value="Basic" style={{ margin: "6px" }}> Basic Level: Có khả năng sử dụng tiếng Anh trong các tình huống hàng ngày, hiểu
                            và sử dụng các cấu trúc cơ bản, có khả năng đọc hiểu văn bản đơn giản và viết các câu hoặc đoạn văn ngắn. </Radio>
                        <Radio value="Intermediate" style={{ margin: "6px" }}> Intermediate Level: Có khả năng giao tiếp lưu loát trong nhiều tình huống, hiểu
                            và sử dụng các cấu trúc ngữ pháp phức tạp hơn, có khả năng đọc hiểu các văn bản thông thường và viết các bài văn có cấu trúc. </Radio>
                        <Radio value="Advanced" style={{ margin: "6px" }}> Advanced Level: Có khả năng giao tiếp tự nhiên và lưu loát trong hầu hết các tình huống, hiểu
                            và sử dụng các cấu trúc ngữ pháp phức tạp, có khả năng đọc hiểu các văn bản chuyên ngành và viết các bài văn có cấu trúc logic. </Radio>
                        <Radio value="Fluent" style={{ margin: "6px" }}> Fluent Level: Có khả năng giao tiếp tự nhiên và lưu loát như người bản xứ, sử dụng linh hoạt các cấu trúc
                            ngữ pháp, đọc hiểu và phân tích các văn bản phức tạp, viết các bài văn có nội dung sâu sắc và phong cách chuyên nghiệp. </Radio>
                        <Radio value="Native" style={{ margin: "6px" }}> Native Level: Sử dụng tiếng Anh thành thạo như người bản xứ, giao tiếp tự nhiên và linh hoạt, sử dụng
                            thành thạo các cấu trúc ngôn ngữ, đọc hiểu và phân tích các văn bản chuyên ngành phức tạp, viết các bài văn một cách chính xác và sáng tạo. </Radio>
                        <Radio value="Expert" style={{ margin: "6px" }}> Expert Level: Sử dụng tiếng Anh với sự thành thạo cao nhất, có khả năng giao tiếp tự nhiên và linh hoạt ở mọi tình huống, sử
                            dụng một cách tinh vi các cấu trúc ngôn ngữ, đọc hiểu và phân tích các văn bản chuyên ngành phức tạp, viết các bài văn một cách chuyên nghiệp và sáng tạo. </Radio>
                    </Radio.Group>
                </div>

...
function ContactItem({ value = '', icon = <></>, redirectAction = '' }: any) {
    return (
        <ContactItemContainer>
            <p className="label">{redirectAction ? <a href={redirectAction}>{value}</a> : <p>{value}</p>}</p>
    ...
    return (
        <IntroContainer>
            ...
            <div className="contact">
                <ContactItem icon={getIcon('mobile')} value={intro.phone} redirectAction={`tel:${intro.phone}`} />
                <ContactItem icon={getIcon('email')} value={intro.email} redirectAction={`mailto:${intro.email}`} />

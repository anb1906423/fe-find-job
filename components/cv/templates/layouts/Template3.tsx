...
import { useIntro, useWork, useSkills, useActivities, useEducation, useLabels } from '../../stores/data.store';

/* Template 3 components */
import { Intro, TechnicalExpertise, UnratedCapsules, Education, Social } from '../components/template3';
import { Section } from '../components/template3/shared';

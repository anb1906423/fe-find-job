...
const DangKyUngVien = () => {
  ...
  const xuLyDangKy = async (e) => {
    ...
    try {
      var response = await axios.post(backendAPI + '/dang-ky/ung-vien',
    ...
    <div className="trang-dang-ky-ung-vien">
      ...
      <div className="chua-form-dang-ky">
        <form className="row g-3 form-dang-ky" onSubmit={xuLyDangKy}>
          ...
          <div className="col-md-6">
            <label htmlFor="inputCity" className="form-label">Số điện thoại</label>
            <input
              type="text"
          ...
          <div className="col-md-6">
            <label htmlFor="inputZip" className="form-label">Ngày sinh</label>
            <input
              type="date"
              className="form-control"
              id="inputZip"
          ...
          <div className="col-12">
            <label className="form-label" htmlFor="gridCheck">Giới tính</label>
          ...
          <div className='w-100 text-center'>
            <p>Đã có tài khoản? <Link style={{ textDecoration: 'none' }} href="/dang-nhap/ung-vien">Đăng nhập</Link></p>
          </div>
        </form>
      </div>
    </div>

      ...
      <div className="chua-form-dang-ky">
        <form className="row g-3 form-dang-ky" onSubmit={xuLyDangNhap}>
          <div className="col-md-6">
            <label htmlFor="inputEmail4" className="form-label">Email đăng nhập *</label>
            <input
              type="email"
          ...
          <div className="col-12">
            <label htmlFor="inputAddress" className="form-label">Tên công ty *</label>
            <input
              type="text"
              className="form-control"
              id="inputAddress"
          ...
          <div className="col-12">
            <label htmlFor="inputAddress2" className="form-label">Địa chỉ liên  hệ *</label>
            <input
              type="text"
              className="form-control"
              id="inputAddress2"
          ...
          <div className="col-md-6">
            <label htmlFor="inputCity" className="form-label">Số điện thoại liên hệ *</label>
            <input
              type="text"
          ...
          <div className="col-md-6">
            <label htmlFor="inputZip" className="form-label">Mã số thuế *</label>
            <input
              type="text"
          ...
          <div className="col-12">
            <label className="form-label" htmlFor="gridCheck">Logo công ty</label>
          ...
          <div className="col-12">
            <button type="submit" className="btn nut-dang-ky w-100">Đăng ký</button>
          </div>
          <div className='w-100 text-center'>
            <p>Đã có tài khoản? <Link style={{ textDecoration: 'none' }} href="/dang-nhap/nha-tuyen-dung">Đăng nhập</Link></p>
          </div>
        </form>
      </div>
    </div>
